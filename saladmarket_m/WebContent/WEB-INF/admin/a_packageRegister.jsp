	...
	$(document).ready(function(){
		...
		$("#btnRegister").bind("click", function(){
			...
			if(flag){
				...
				var frm = document.packageRegisterFrm;
				frm.method="POST";
				frm.action="a_packageRegister.do";
				frm.submit();
			}
		});
  	...
  	<div class="row">
            <div class="card">
              <div class="card-header">
                <h5 class="title">패키지 등록</h5>
              </div>
              <div class="card-body">
                <form name="packageRegisterFrm" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-12 pl-md-8">
                      <div class="form-group">
                        <label>패키지명</label>
                        <input type="text" class="form-control infoData" name="pacname" id="pacname" ><span></span>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-8 pl-md-3">
                      <div class="form-group">
                        ...
                        <textarea rows="4" cols="80" class="form-control infoData" name="paccontents" id="paccontents" placeholder="설명을 입력하세요"></textarea><span></span>
                      </div>
                    </div>
                  </div>
	              <label>패키지 대표이미지(필수)</label>	              
	              <ul style="list-style-type: none;">
	              	<li>
	              		<input type="file" name="pacimage" id="pacimage" class="infoData btn btn-primary btn-simple"/>
	              		<span></span>
	              	</li>
	              </ul>
                </form>
