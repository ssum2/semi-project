			...
			<div id="BEST" class="tabcontent" style="display: block;">
				<div id="page">
					<div class="colorlib-shop">
						<div class="row">
						<c:forEach var="productvo" items="${productListBySpec}">
							<div class="col-md-3 text-center">
								<div class="product-entry">		
									<div class="product-img" OnClick="goDetail(${productvo.pnum});" style="background-image: url(<%=CtxPath%>/store/images/item-9.jpg);">
										<p class="tag"><span class="sale">Best</span></p><!-- sale이라는 클래스가 디자인이 걸려 있어서 그냥 클래스는 sale로 할께요 -->
				                        <div class="cart">
				                           <p>
				                              <span class="addtocart"><a href="addCart.do?pnum=${productvo.pnum}"><i class="icon-shopping-cart"></i></a></span> 
				                              <span><a href="productDetail.do?pnum=${productvo.pnum}"><i class="icon-eye"></i></a></span> 
				                              <span><a href="addProdLike.do?pnum=${productvo.pnum}"><i class="icon-heart3"></i></a></span>
				                              <span><a href="addMyPick.do?${productvo.pnum}"><i class="icon-bar-chart"></i></a></span>
				                           </p>
				                        </div>
                    				</div>
                    				
				                    <div class="desc">
				                       <h3><a href="productDetail.do?pnum=${productvo.pnum}">${productvo.pname}</a></h3>
				                       <p class="price"><span>${productvo.price}</span> <span class="sale">${productvo.saleprice}</span> </p>
				                    </div>
                  				</div>
               				</div>
						</c:forEach>
...
<div align="center" class=" col-md-offset-2 col-md-8" style="margin-top: 50px; display: block;">
    <div id="page">
         <div class="colorlib-shop">
            <div class="row">
            <c:forEach var="productvo" items="${productListBySdname}">
				<div class="col-md-3 text-center">
					<div class="product-entry">		
						<div class="product-img" OnClick="goDetail(${productvo.pnum});" style="background-image: url(<%=CtxPath%>/store/images/item-9.jpg);">
							<p class="tag"><span class="sale">Best</span></p><!-- sale이라는 클래스가 디자인이 걸려 있어서 그냥 클래스는 sale로 할께요 -->
